...
| `form/fader`              | `FluxFormFader` ⚠ | Inline labeled slider (whole row is the track, label left + value right). **Not** `FluxFader` (that is the fade carousel) |
| `form/fader/ranged`       | `FluxFormRangeFader` ⚠ | Range variant of the inline fader |
